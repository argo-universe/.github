# Contributing Guidelines for Argo Universe
...
- [Contributing Guidelines for Argo Universe](#contributing-guidelines-for-Argo Universe)
...
There are three classes of contributors possible: Contributor, Code Owner, and Maintainer. Join our community meetings to learn more about Argo Universe and engage with other contributors.

## Ways you can contribute

### 1. Report issues

Issues to Argo Universe help improve the project in multiple ways including the following:
...
New contributors may easily view all [open issues labeled as good first issues](https://github.com/ArgoUniverse/ArgoUniverse/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) allowing you to get started in an approachable manner.

Once you wish to get started contributing to the code base, please refer to our [running in development mode](https://github.com/ArgoUniverse/ArgoUniverse/wiki/Running-in-development-mode) for local setup guide.
...
2. For new or changed functionality, this typically requires documentation and so raise a corresponding issue (or, better yet, raise a separate PR) on the [documentation repository](https://github.com/ArgoUniverse/website).
3. Test your change with the [Argo Universe CLI](https://ArgoUniverse.io/docs/ArgoUniverse-cli/) and provide a test manifest in the proper format. If your feature/fix does not work with the CLI, a separate issue requesting CLI support must be made. For changes which can be tested as an end user, we require conformance/e2e tests by using the `kuttl` tool. See [here](https://github.com/ArgoUniverse/ArgoUniverse/tree/main/test/conformance/kuttl/README.md) for a specific guide on how and when to write these tests.
...
Once you fork the project, you will notice that there are a number of branches related to Argo Universe's releases such as release-1.7. You can view the list of remote branches by using the command below:
